...
#[derive(Debug)]
pub struct AtomicSwapProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AtomicSwapProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AtomicSwap processing");
    
    let mut processor = AtomicSwapProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AtomicSwapProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AtomicSwapProcessor::new(false);
